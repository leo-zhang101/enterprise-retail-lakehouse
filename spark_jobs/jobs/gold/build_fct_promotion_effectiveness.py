"""
Gold build: fct_promotion_effectiveness.
Grain: one row per promotion. Purpose: promotion effectiveness mart.
"""
...
def run(load_date: str, **kwargs) -> None:
    run_gold_build("fct_promotion_effectiveness", load_date, **kwargs)
